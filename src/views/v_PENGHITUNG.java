...
public class v_PENGHITUNG extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 380, 419, 400));
        ...
        getContentPane().add(hasilHitungan, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 270, 180, 30));

        kg1.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        kg1.setText("KG");
        getContentPane().add(kg1, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 260, 30, 40));

        kg.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        kg.setText("CM");
        getContentPane().add(kg, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 210, 30, 40));

        lingkarDada.setBorder(null);
        lingkarDada.setInheritsPopupMenu(true);
        lingkarDada.setOpaque(false);
        getContentPane().add(lingkarDada, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 210, 170, 40));

        btnUpdate.setBorder(null);
        btnUpdate.setBorderPainted(false);
        btnUpdate.setContentAreaFilled(false);
        getContentPane().add(btnUpdate, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 320, 120, 52));

        btnKembali.setBorder(null);
        btnKembali.setBorderPainted(false);
        btnKembali.setContentAreaFilled(false);
        getContentPane().add(btnKembali, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 810, 121, 40));

        nomorSapi.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-" }));
        getContentPane().add(nomorSapi, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 150, 210, 30));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/UKUR BERAT.png"))); // NOI18N
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 500, 870));
